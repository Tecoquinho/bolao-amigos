...
$confirmedResults = @(
    ...
    @{ MatchNumber = 5; HomeScore = 0; AwayScore = 3; Game = "Czechia x Mexico" },
    @{ MatchNumber = 6; HomeScore = 1; AwayScore = 0; Game = "South Africa x South Korea" },
    ...
    @{ MatchNumber = 11; HomeScore = 2; AwayScore = 1; Game = "Switzerland x Canada" },
    @{ MatchNumber = 12; HomeScore = 3; AwayScore = 1; Game = "Bosnia and Herzegovina x Qatar" },
    @{ MatchNumber = 13; HomeScore = 1; AwayScore = 1; Game = "Brazil x Morocco" },
    @{ MatchNumber = 14; HomeScore = 0; AwayScore = 1; Game = "Haiti x Scotland" },
    @{ MatchNumber = 17; HomeScore = 0; AwayScore = 3; Game = "Scotland x Brazil" },
    @{ MatchNumber = 18; HomeScore = 4; AwayScore = 2; Game = "Morocco x Haiti" },
    ...
    @{ MatchNumber = 23; HomeScore = 3; AwayScore = 2; Game = "Turkiye x United States" },
    @{ MatchNumber = 24; HomeScore = 0; AwayScore = 0; Game = "Paraguay x Australia" },
    ...
    @{ MatchNumber = 29; HomeScore = 2; AwayScore = 1; Game = "Ecuador x Germany" },
    @{ MatchNumber = 30; HomeScore = 0; AwayScore = 2; Game = "Curacao x Ivory Coast" },
    ...
    @{ MatchNumber = 35; HomeScore = 1; AwayScore = 3; Game = "Tunisia x Netherlands" },
    @{ MatchNumber = 36; HomeScore = 1; AwayScore = 1; Game = "Japan x Sweden" },
    ...
    @{ MatchNumber = 41; HomeScore = 1; AwayScore = 5; Game = "New Zealand x Belgium" },
    @{ MatchNumber = 42; HomeScore = 1; AwayScore = 1; Game = "Egypt x Iran" },
